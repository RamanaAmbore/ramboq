...
email_contact_tmpl = """
        <html>
          <body>
            ...
            <p>Best regards,<br>[RamboQuant team]</p>
          </body>
        </html>
        """
...
email_reg_tmpl = """
        <html>
          <body>
            ...
            <ol> <li><b>Sign in</b> to your account using your registered email and password.</li> <li><b>Update your profile</b> with the required information.</li> <li>Your registration details will be <b>reviewed and validated by a member of the RamboQuant team</b>.</li> <li>Once your profile is approved, you will receive a confirmation. <b>You will then be able to access and use all features of your account.</b></li> </ol>
        ...
        <html>
          <body>
            ...
            <p>
              ...
              <ol>
                <li>Your registration and profile information will now be <b>reviewed and validated by a member of the RamboQuant team</b>.</li>
