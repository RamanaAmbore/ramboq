...
- **`api/routes/algo.py`** — Algo Agents API + WebSocket `/ws/algo`
...
### SvelteKit Pages
- **`+layout.svelte`** — Nav with Admin ▾ dropdown (Terminal, Algo Agents, Orders, Users); mobile hamburger
...
- **`algo/`** — Algo Agents dashboard: status, positions to close, chase orders, live event log
